...
///
/// GDB support reporting either section offsets, or segment addresses
pub enum Offsets<U> {
...
/// Target Extension - section/segment relocation offsets from the target.
///
...
/// for details see issue [#20](https://github.com/daniel5151/gdbstub/issues/20)
///
/// For System-V architectures GDB is capable of extracting library offsets
/// from memory as long as it knows the base address of the dynamic linker.
/// The base address can be specified by either implementing this command
